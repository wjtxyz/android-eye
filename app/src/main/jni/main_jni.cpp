...
JOW(int, nativeDoVideoEncode)(JNIEnv *env, jclass, jbyteArray _yuvData, jbyteArray _nalsData,
                              jint flag) {
...
JOW(int, nativeDoAudioEncode)(JNIEnv *env, jclass, jbyteArray pcmData, jint length,
                              jbyteArray g726Data) {
    jboolean isCopy = JNI_TRUE;
